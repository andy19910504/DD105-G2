...
>>>>>>> 539dba2f4dc4f1cf7a323173141522a9c57f3c41
    ...
    $sql1 = "select * from `routes` a join `custom_attraction_list`b on( a.route_number=b.route_number) join `custom_attraction`c on( b.custom_attraction_number=c.custom_attraction_number) where member_number=:memNum
    ";
