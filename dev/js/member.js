...
$(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>div`).click(function(){
    //修改隱藏
    $(this).css("display","none");
    //確認出現
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>a:nth-child(2)`).css("display","inline-block");
    //刪除隱藏
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>a:nth-child(3)`).css("display","none");
    //欄位去除READONLY
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) input`).removeAttr("readonly");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) textarea`).removeAttr("readonly");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) input`).css("pointer-events","auto");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) textarea`).css("pointer-events","auto");
    //第一個欄位FOCUS
    ...
    //下方照相機出現
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)>label:nth-child(1)>div:nth-child(1)>div:nth-child(2)`).css("display","inline-block");
    //可更新相片
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)>label`).css("pointer-events","auto");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)`).click(function(){
        $(this).css("border","3px dashed #a5361c");
    })

});
$(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>a:nth-child(2)`).click(function(){
    $(this).css("display","none");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>div`).css("display","inline-block");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) input`).attr("readonly","true");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) textarea`).attr("readonly","true");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)>label:nth-child(1)>div:nth-child(1)>div:nth-child(2)`).css("display","none");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)>label`).css("pointer-events","none");
    // $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3)>div>input`).css("border-bottom","1px solid #646464");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) input`).css("pointer-events","none");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(3) textarea`).css("pointer-events","none");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(2)`).css("border","unset");
    $(`.member_info_open_all>div:nth-child(${i})>div:nth-child(4)>a:nth-child(3)`).css("display","inline-block");
})
}
